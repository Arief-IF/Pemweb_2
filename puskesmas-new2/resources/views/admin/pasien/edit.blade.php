<x-layout>
    <x-slot name="page_name">Edit Data Pasien</x-slot>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="email" name="email"
                        placeholder="Masukkan Akun Email" value="{{ $pasien->email }}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="kecamatan_nama" name="kecamatan_nama"
                        placeholder="Masukkan Nama Kecamatan" value="{{ $pasien->kecamatan_nama }}">
                </div>
            </div>
            <div class="form-group row">
