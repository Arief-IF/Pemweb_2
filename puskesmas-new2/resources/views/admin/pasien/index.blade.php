            ...
            @foreach ( $list_pasien as $pasien )
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ url('dashboard/pasien/show', $pasien->id) }}" class="text-warning"><i class="far fa-edit"></i> Edit</a> |
                        <a href="{{ url('dashboard/pasien/show', $pasien->id) }}" class="text-danger"><i class="far fa-trash-alt"></i> Hapus</a>
                    </td>
                </tr>
            @endforeach
